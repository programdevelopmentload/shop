        ...
        success: function (data) {
            ...
            if (data.success == true) {
                ...
                if (_levelSign == '3') {
                    ...
                    $('.everyGradeAdd').attr('href', './front_everyGrade_add.html?selfId=' + _id + '&isLeaf=1&editSign=0&level=3')
                    $('.everyGrade_rename').attr('href', './front_everyGrade_edit.html?selfId=' + _id + '&isLeaf=1&editSign=1&level=2&name=' + _name);
                    $('switch_page_con').hide();
                    ...
                    $(".evg_msg_middle").hide();
                    $(".switch_page_con").hide();
                    $('.everyGrade_rename').attr('href', './front_everyGrade_edit.html?selfId=' + _id + '&isLeaf=0&editSign=1&level=1&name=' + _name);
                    $('.everyGradeAdd').html("添加二级分类");//
                    $('.everyGradeAdd').attr('href', './front_everyGrade_add.html?selfId=' + _id + '&isLeaf=0&editSign=0&level=2')
                    $('.guide_content').html('下级分类');
                }
                ;
            } else {
