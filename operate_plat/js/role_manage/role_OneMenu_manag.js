...
//平台列表地址
var menu_Url = localUrl + '/user/menu/getLevelMenu';
    ...
    if (data.length == 0) {   //没有资源时
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            content.append(
                ...
                '<td class="operate_con" data-id="' + va_id + '"><a class="_change page_miniBtnm" href="./role_twoMenu_manag.html?&edit=0&id=' + va_id + '">查看</a><a class="_change page_miniBtnm" href="./role_menu_add.html?&edit=1&id=' + va_id + '">编辑</a><span class="_close page_miniBtn" onclick="role_Dele(this)">删除</span></td>' +       //操作
                '</tr>'
            )
            ;
        }
