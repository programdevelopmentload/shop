...
//分页
debugger;
var uMverify_PageUrl = localHtttp + "/user/seller/cautionMoneyRecordList";
    ...
    if (!data) {   //没有资源时
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            content.append(
                ...
                '<td>' + data[i].cautionMoney + '</td>' + //缴纳金额
                '<td>' + data[i].payTime + '</td>' + //缴纳时间
                '<td>' + data[i].isCautionMoney + '</td>' + //缴纳状态
